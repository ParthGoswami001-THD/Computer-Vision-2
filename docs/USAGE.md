...
(red, yellow, green, …), to resemble the assignment's target figure.
...
| parameter        | effect                                                    |
|------------------|-----------------------------------------------------------|
| `s_min`, `v_min` | guard mask — raise to exclude more shadow/background       |
...
`color_space.py` — until you can derive them yourself. Keep the AI-usage
declaration on your closing slide.
